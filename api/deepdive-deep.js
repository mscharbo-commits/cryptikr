...
export default async function handler(req, res) {
  ...
  var anthropicResp = await fetch('https://api.anthropic.com/v1/messages', {
    ...
    body: JSON.stringify({ model:'claude-haiku-4-5-20251001', max_tokens:800, stream:true, messages:[{role:'user',content:prompt}] }),
  });
